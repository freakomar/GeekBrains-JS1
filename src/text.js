var works = {
    ...
    d00: 'Вы подождали пока вам накроют на стол и плотно пообедали.\n' +
    'Потом вы занялись делами по хозяйству\n' + 
    'Потом вы решили...\n',
    d0: 2, // кол-во ответов
    d1: '1 - Подольше погулять и лечь спать поздно\n',
    d2: '2 - Лечь спать поряньше\n',
};
